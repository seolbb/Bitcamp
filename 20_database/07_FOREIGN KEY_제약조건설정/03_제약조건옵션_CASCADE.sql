...
CASCADE : 부모테이블(PARENT)의 제약조건을 비활성화 시키면서
    참조하고있는 자녀(CHILD) 테이블의 제약조건까지 비활성화
****************************/
SELECT * FROM DEPT;
SELECT * FROM EMP01;
...
---- FK 비활성화(DISABLE) 설정으로는 안됨. FK 삭제해야함
